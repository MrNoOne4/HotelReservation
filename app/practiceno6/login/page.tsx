    ...
    <div className="m-0 p-0 box-border h-screen flex justify-center items-center font-sans bg-cover bg-center" style={{ backgroundImage: `linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url(${RGBSmooth.src})`, }}>
      <div className='h-auto w-xs lg:w-200 rounded-md border flex bg-white/30 backdrop-blur-md'>
        ...
        <div className='w-full'>
          ...
          <form className='flex flex-col p-10 justify-center h-full'>
            ...
            <div className='relative w-full'>
              <div className='absolute top-2 left-2'>
                ...
                <input type="email" id="email" placeholder=" " className="w-full mb-4 pl-10 p-2 border-b outline-none peer focus:border-black not-placeholder-shown:border-black " />
            ...
            <div className='relative w-full mt-3'>
              ...
              <input type={showPassword ? "password" : "text"} placeholder=' ' className='w-full mb-4 pl-10 p-2 pr-11 border-b  outline-none peer focus:border-black not-placeholder-shown:border-black ' />
